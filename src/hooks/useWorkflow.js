...
export function useWorkflow() {
  ...
  const [running, setRunning] = useState(null) // workflowId or null
  const [stepStatuses, setStepStatuses] = useState({}) // { [stepIndex]: { status, output, chunk, duration, error } }
  ...
  return { workflows, running, stepStatuses, load, save, remove, runWorkflow, abort }
}
